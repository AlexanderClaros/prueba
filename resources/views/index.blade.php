        ...
        <nav class=" sticky top-0 p-5 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-slate-800 via-slate-700 to-gray-800 shadow md:flex md:items-center md:justify-between">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="text-orange-400/75 md:mt-1 bi bi-fuel-pump" viewBox="0 0 16 16">
                ...
                <a href="#" class="font-display max-w-sm text-3xl font-bold leading-tight">
                    <span class="link link-underline link-underline-orange text-white">
                        Geoportal
                    </span>
                </a>
        ...
        <div class="container flex flex-wrap items-start mt-8 mx-auto">
          ...
          <div class="w-full mx-auto md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2 mr-2">
            ...
            <div class="bg-gray-600 rounded-lg m-h-64 p-2 transform hover:-translate-y-2 hover:shadow-xl transition duration-300">
                ...
                <figure class="mb-2">
                    <img src="https://cdn-icons-png.flaticon.com/512/8940/8940365.png " alt="" class="h-64 ml-auto mr-auto" />
                </figure>
          ...
          <div class="w-full mx-auto md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2 ml-2">
            ...
            <div class="bg-gray-600 rounded-lg m-h-64 p-2 transform hover:-translate-y-2 hover:shadow-xl transition duration-300">
              ...
              <figure class="mb-2">
              <img src="https://cdn-icons-png.flaticon.com/512/8552/8552053.png" alt="" class="h-64 ml-auto mr-auto" />
              </figure>

              <div class="rounded-lg p-4 flex flex-col">

                <div>
                  <h5 class="text-2xl font-bold text-white leading-none text-center"> Postes Maritimos </h5>
                  <p class="mt-4 text-white text-justify">
        ...
        <footer class="bg-white dark:bg-gray-800 mt-2">
            ...
            <div class="mx-auto w-full container p-4 sm:p-6">
                ...
                <div class="md:flex md:justify-between ">
                    ...
                    <div class="mb-6 md:mb-0 md:flex md:space-x-2">

                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="text-orange-400/75 md:mt-11 bi bi-fuel-pump" viewBox="0 0 16 16">
                            <path d="M3 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-5Z"/>
                            <path d="M1 2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v8a2 2 0 0 1 2 2v.5a.5.5 0 0 0 1 0V8h-.5a.5.5 0 0 1-.5-.5V4.375a.5.5 0 0 1 .5-.5h1.495c-.011-.476-.053-.894-.201-1.222a.97.97 0 0 0-.394-.458c-.184-.11-.464-.195-.9-.195a.5.5 0 0 1 0-1c.564 0 1.034.11 1.412.336.383.228.634.551.794.907.295.655.294 1.465.294 2.081v3.175a.5.5 0 0 1-.5.501H15v4.5a1.5 1.5 0 0 1-3 0V12a1 1 0 0 0-1-1v4h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1V2Zm9 0a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v13h8V2Z"/>
                        </svg>
