@extends('index')
    ...
    <div class="max-w-lg my-4 mx-auto bg-gray-700/75 rounded-lg">
        ...
        <form method="get" action="/update/{{$edit['id']}}" class=" shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                <label for="ticket" class="block text-white text-sm font-bold mb-2">Localidad:</label>
            ...
            <div class="mb-4">
                <label for="value" class="block text-white text-sm font-bold mb-2">Direccion:</label>
            ...
            <div class="mb-4" >
                <label for="ticket"class="block text-white text-sm font-bold mb-2">DieselA:</label>
            ...
            <div class="mb-4">
                <label for="value" class="block text-white text-sm font-bold mb-2">Diesel Premium:</label>
            ...
            <div class="mb-4">
                <label for="ticket" class="block text-white text-sm font-bold mb-2">Gasolina 95 e5:</label>
            ...
            <div class="mb-4">
                <label for="value" class="block text-white text-sm font-bold mb-2">Gasolina 98 e5:</label>
            ...
            <div class="mb-4">
                <label for="value" class="block text-white text-sm font-bold mb-2">Horario:</label>
